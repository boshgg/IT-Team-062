...
public class CustomerInfoDBHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_LANGUAGE = "phone";
...
//    }
    ...
    public void add_customer(String name, String birthday, String age, String gender,
